...
using ArggonStores.Application.TodoItems.Commands.CreateTodoItem;
using ArggonStores.Application.TodoItems.Commands.DeleteTodoItem;
using ArggonStores.Application.TodoItems.Commands.UpdateTodoItem;
using ArggonStores.Application.TodoItems.Commands.UpdateTodoItemDetail;
using ArggonStores.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace ArggonStores.Web.Endpoints;
